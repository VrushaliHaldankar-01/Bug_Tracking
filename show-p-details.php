    ...
    <html lang="en">
        ...
        <body>
            ...
            <form action="tester-dashboard.php" method="POST">
                <button type="submit" name="back" class="btn btn btn-danger" style="margin-left: 30px; margin-top: 20px;">
            ...
            <div class="container projectDetails">
                ...
                <form action="create-project.php" method="POST">
                    <button type="submit" class="btn btn-danger" name="edit-project">Edit</button>
                </form>
                <br>

                <form action="see-issues.php" method="POST">
